...
function mostrarElemtrosLista() {
    ...
    for (let i = 0; i < lista.length; i++){
        productosCompra.innerHTML += `<div><div class="img"><button onclick=eliminar(${i}) class="botonTrash"><img id="trash" class="trash" src="img/trash.png" alt=""></button><p>${lista[i].nombre}</p></div><p> $${lista[i].precio}</p></div>`
